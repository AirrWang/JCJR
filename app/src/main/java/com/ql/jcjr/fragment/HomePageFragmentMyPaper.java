...
import com.ql.jcjr.adapter.AdvertInfoViewPaperAdapterMax;
 ...
 */
public class HomePageFragmentMyPaper extends BaseFragment{
    ...
    private final int advertSum = 20;
    ...
    protected int getContentView() {
        return R.layout.fragment_home_page_my;
    }
    ...
    private void initAdvert(final ArrayList<BannerEntity.ResultBean> list) {
        ...
        if(advertLength > 0){
            ...
            currentIndex = ((advertSum/2)/advertLength)*advertLength;
            viewFlow.setAdapter(new AdvertInfoViewPaperAdapterMax(getActivity(), list, pageViews, advertSum));
            viewFlow.setOffscreenPageLimit(3);
...
//                field.set(viewFlow,currentIndex);
//
////                Field field2 = ViewPager.class.getDeclaredField("mFirstLayout");
////                field2.setAccessible(true);
////                field2.set(viewFlow,false);
//            }catch(Exception e){
//
//            }
            ...
            mHandler = new Handler() {
                public void handleMessage(Message msg) {
                    if(msg.what==1){
                        ...
                        if(tempIndex >= advertSum-1){
                            tempIndex = 0;
                        }

                        viewFlow.setCurrentItem(tempIndex);
//                        currentIndex++;
                    }
                };
            };
    ...
    class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            currentIndex = arg0;
            setImageBackground(arg0 % pageViews.length);
        }
