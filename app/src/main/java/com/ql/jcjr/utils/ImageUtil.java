...
//            LogUtil.d(FileUtil.class, "getBitmapFromDrawable ：" + e.getMessage());
     ...
     * @param drawable 资源文件
     */
    public static void saveImageFromDrawable(Context mContext, String path, String srcName, int drawable) {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            ...
            if (!fileImage.exists()) {
                try {
                    Bitmap pic = BitmapFactory.decodeResource(mContext.getResources(), drawable);
                    ...
                    e.printStackTrace();
                    LogUtils.e("saveImage" + e.toString());
                }
            } else {
                LogUtils.e("保存的icon已存在");
            }
        }
    }
