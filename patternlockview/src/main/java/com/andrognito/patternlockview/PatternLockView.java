...
public class PatternLockView extends View {
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mAspectRatioEnabled =
                    typedArray.getBoolean(R.styleable.PatternLockView_aspectRatioEnabled,
                            false);
    ...
    public void setPattern(
            @PatternViewMode
                    int patternViewMode, List<Dot> pattern) {
        mPattern.clear();
    ...
    public void setNormalStateColor(
            @ColorInt
    ...
    public void setWrongStateColor(
            @ColorInt
                    int wrongStateColor) {
